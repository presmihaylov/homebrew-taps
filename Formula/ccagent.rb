class Ccagent < Formula
  ...
  on_macos do
    if Hardware::CPU.arm?
      ...
      sha256 "235c2d6b3d6ae2aafba6391155638982ad50c46deacaf2966191ad5e78758643"
    else
      url "https://github.com/presmihaylov/ccagent/releases/download/v#{version}/ccagent-v#{version}-darwin-x86_64"
      sha256 "bfde2a717b2fdef3c1231c27ad3115a1cd8a13bd2588a1c493f72b2ff3a0db97"
    end
  end
  ...
  on_linux do
    if Hardware::CPU.arm?
      ...
      sha256 "d92af61be13f69bc41f68158f504ec544305da62a5bb1ba0c1bc569555f6ef39"
    else
      url "https://github.com/presmihaylov/ccagent/releases/download/v#{version}/ccagent-v#{version}-linux-x86_64"
      sha256 "8fc7ed2b7b34e5429fb738770cdaba781e039ff7648430edddfc2223ffab7146"
    end
  end

class Ccagent < Formula
  ...
  on_macos do
    if Hardware::CPU.arm?
      ...
      sha256 "706851eecb840d89ead836f0a2bb88138b324103c4d515cfc6ba3945def0fbab"
    else
      url "https://github.com/presmihaylov/ccagent/releases/download/#{version}/ccagent-#{version}-darwin-x86_64"
      sha256 "a0b05cd911d7ff1e4af35cdefcea577c59c2a7a4c543f2596796533e523f26f8"
    end
  end
  ...
  on_linux do
    if Hardware::CPU.arm?
      ...
      sha256 "3d908057b01e579ce3212c3b6cbacf8f004be98086b42f93b40e939cf16b4f0c"
    else
      url "https://github.com/presmihaylov/ccagent/releases/download/#{version}/ccagent-#{version}-linux-x86_64"
      sha256 "84234ace404d862e9d367dbc75c250154985906b2211192867e7cda9e891cbbb"
    end
  end

class Ccagent < Formula
  ...
  on_macos do
    if Hardware::CPU.arm?
      ...
      sha256 "3faebf8168a7590bdf8836df3a80db72bbbda0a2f3dd15f5be0c5cdb738fbf43"
    else
      url "https://github.com/presmihaylov/ccagent/releases/download/v#{version}/ccagent-v#{version}-darwin-x86_64"
      sha256 "ee4f3f4792a5db4a50e52280038b329927b21aecf362e7593e84e11b95ea2c1d"
    end
  end
  ...
  on_linux do
    if Hardware::CPU.arm?
      ...
      sha256 "e240f0e7724062195073e1dae0afee5c7f1609b5a15fff4b77c224e0c723237e"
    else
      url "https://github.com/presmihaylov/ccagent/releases/download/v#{version}/ccagent-v#{version}-linux-x86_64"
      sha256 "26c824b63ee359829c0980e5ba610dabd00efb7248a1237c677da8cc877caf76"
    end
  end

class Ccagent < Formula
  ...
  on_macos do
    if Hardware::CPU.arm?
      ...
      sha256 "f97d273f2a1c1b67899e04f11152cf3fc15d8266c18c7f85e0422e02c99fc2ee"
    else
      url "https://github.com/presmihaylov/ccagent/releases/download/v#{version}/ccagent-v#{version}-darwin-x86_64"
      sha256 "ebd327bb4a4fe562d00f626d7b1aad5a5fc72aaada57c47f2f1b21ed790050bd"
    end
  end
  ...
  on_linux do
    if Hardware::CPU.arm?
      ...
      sha256 "0d877d67b87e5101c24b9c4d657a3c3967e25d87f8852c32f072b0fe2544adfb"
    else
      url "https://github.com/presmihaylov/ccagent/releases/download/v#{version}/ccagent-v#{version}-linux-x86_64"
      sha256 "62f49d57443b02f9076c1c8cc015ed3ffdfa26de322b06e54fd2d279ee532609"
    end
  end
